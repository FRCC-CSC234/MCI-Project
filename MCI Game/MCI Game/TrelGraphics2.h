...
private:
	...
	static int windowHeight;		//  Window Length 
...
public:
	...
	void addPictureToFrameRotationResize( int pictureID, int x, int y, int w, int h, double degrees, bool vFlip, bool hFlip, SDL_Point *center=NULL );
